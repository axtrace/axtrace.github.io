...
4. Спроси маму
5. Тайны сороковки
6. Дьявол играет нами, когда мы мыслим неточно
7. Жемчужины разработки
8. Байки для оруженосца
9. Уставшие

## 2024
1. Kubernetes for Kids. Путеводитель для детей
2. System design. Подготовка к сложному интервью
3. Балдеющие от адреналина и зомбированные шаблонами
4. A значит Anonymos

## 2023
1. Мама, я тимлид
2. UML 2 и Унифицированный процесс
3. Ловушка счастья
4. 0,05. Доказательная медицина
5. Мемы. Научный взгляд на феномен поп-культуры, захвативший мир
6. Идеальный программист
...
3. Выбор
4. Применение объектного моделирования с использованием UML
5. Искусство быть невидимым
6. Большая книга манипуляций
7. Чек-лист. Система предотвращения ошибок
...
6. Защита от тёмных искусств
7. Моделирование бизнес-процессов в нотации BPMN.
8. Анализ и проектирование систем с использованием UML.
9. Вопрос смерти и жизни
