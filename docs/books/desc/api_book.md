---
description: "Рецензия на книгу «API» Сергея Константинова - практическое руководство по проектированию API с примерами и лучшими практиками"
keywords: "API, проектирование API, Сергей Константинов, разработка API, REST API, веб-разработка, программирование, рецензия книги"
---
...
Отличная книга! Несмотря на описания API-шек псевдокодом, читается очень легко и понятно.
...
> Главное правило интерфейсов ошибок в API таково: из содержимого ошибки клиент должен в первую очередь понять, что ему делать с этой ошибкой
