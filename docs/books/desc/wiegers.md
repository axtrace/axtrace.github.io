---
description: "Рецензия на книгу «Разработка требований к ПО» Карла Вигерса - монументальное руководство по сбору и управлению требованиями"
keywords: "Разработка требований к ПО, Карл Вигерс, требования, системный анализ, бизнес-анализ, software requirements, рецензия книги"
---
...
![](../../_images/books/desc/img/class_info.png)
