---
description: "Рецензия на книгу «Вдохновленные» Марти Кагана - руководство по управлению продуктами, экспериментам и непрерывным поставкам"
keywords: "Вдохновленные, Марти Каган, продакт-менеджмент, управление продуктами, MVP, прототипирование, product management, рецензия книги"
---
...
Проверять нужно идеи, риски, реализуемость, ценность. В книге, на удивление, подробно рассказали про несколько типов прототипов (рифма, ага). Каждый для своей цели.
