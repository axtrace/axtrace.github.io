...
В какой-то момент я перестал вести этот список, потому что авторы догадались сделать сайт с контентом https://eshenepozner.ru/episodes

Но не факт, что сайт доступен
