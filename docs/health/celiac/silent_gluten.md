...
- вареные колбасы, сосиски, полуфабрикаты из измельчённого мяса и рыбы;
...
{% note info "Овёс — отдельный вопрос" %}

Вопрос о токсичности овса для больных целиакией остаётся спорным. Большинство исследователей считают, что авенины овса не токсичны, однако овсяная крупа часто контаминирована примесями других злаков, особенно пшеницы. В связи с этим в России употребление овса при целиакии не рекомендуется.

{% endnote %}

### Нетоксичные злаки при целиакии
