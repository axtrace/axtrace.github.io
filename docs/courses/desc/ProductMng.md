---
description: "Обзор курса «Управление IT-проектами и продуктом» - зоны ответственности продакт-менеджера с примерами"
keywords: "продакт-менеджмент, управление продуктом, CustDev, UX-исследования, A/B-тесты, MVP, обзор курса"
---
